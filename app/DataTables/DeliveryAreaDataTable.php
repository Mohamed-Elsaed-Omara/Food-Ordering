...
class DeliveryAreaDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        ->addColumn('action', function ($query) {
            $edit = "<a href='" . route('admin.delivery-area.edit', $query->id) . "' class='btn btn-primary' title='edit'><i class='fas fa-edit'></i></a>";
            $delete = "<a href='" . route('admin.delivery-area.destroy', $query->id) . "' class='btn btn-danger mx-2 delete-item' title='delete' ><i class='fas fa-trash'></i></a>";
        ...
        ->rawColumns(['status','delivery_fee','action'])
